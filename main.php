...
<head>
    <meta charset="UTF-8">
    <title>Admin Panel | Aplikasi Management Gudang Konveksi</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Management Gudang Konveksi">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="?module=beranda" class="logo">
                ...
                <img src="images/11aa.png" alt="Gambar"
                    style="width: 35px; float: left; margin-right: 0px; margin-top: 7px;">
                <h5 style="margin-top:10px"><b>Aplikasi Management Gudang Konveksi</b></h5>
