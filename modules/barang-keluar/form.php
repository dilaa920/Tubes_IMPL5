                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables1">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="?module=form_barang_keluar&proses=<?php echo $data['kode_barang']; ?>"
                                        class="btn btn-success btn-xs"><i class="fa fa-download"></i> Prosess</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
...
<div class="row">
    <div class="col-md-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kdbarang" name="kdbarang" disabled="disabled"
                            value="<?php echo $kdbar; ?>">
                    </div>
                    <div class="form-group">
            ...
            <div class="panel-footer">
                <?php if ($kdbar === ""): ?>
                <button class="btn btn-info" name="tambah" id="tambah" disabled="disabled"><i class="fa fa-plus"></i>
                    Tambah</button>
                <?php endif ?>
                <?php if ($kdbar !== ""): ?>
            ...
            <div class="panel-body">
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kdbrgkeluar" id="kdbrgkeluar" maxlength="20"
                            readonly="true" value="<?php echo $kode; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="chosen-select" name="kdproject" data-placeholder="-- Pilih No Project --"
    ...
    <div class="col-md-12">
        <div class="panel-footer" align="center">
            ...
            <button id="formbtn" class="btn btn-primary" name="save" value="save"><i class="fa fa-save"></i>
                Simpan</button>

            <?php endif ?>
            <?php if ($cekbarang === false): ?>
            <button id="formbtn" class="btn btn-primary" name="save" disabled="disabled"><i class="fa fa-save"></i>
                Simpan</button>
        ...
        <table class="table table-bordered table-responsive table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?module=form_barang_keluar&hapus=<?php echo $data['id_keluar_sementara']; ?>"
