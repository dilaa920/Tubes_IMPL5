...
<section class="content-header">
    <h1>
        ...
        <a class="btn btn-primary btn-social pull-right" href="?module=form_barang_keluar&form=add" title="Tambah Data"
            data-toggle="tooltip">
    ...
    ?>
            ...
            while ($data = mysqli_fetch_assoc($query)) {
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$data[tanggal_keluar]</td>
