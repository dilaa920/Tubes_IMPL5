            ...
            <div class="panel-body">
                <form method="POST">
                    ...
                    <div class="panel-footer">
                        <?php if ($kdbar === ""): ?>
                        <button class="btn btn-info" name="tambah" id="tambah" disabled="disabled"><i
                                class="fa fa-plus"></i> Tambah</button>
                        <?php endif ?>
                        <?php if ($kdbar !== ""): ?>
                        <button class="btn btn-info" name="tambah" id="tambah"><i class="fa fa-plus"></i>
                            Tambah</button>
                        <?php endif ?>
                ...
                <div class="panel-body">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kdproject" id="kdproject" maxlength="20"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="chosen-select" name="kode_purchase"
                                    data-placeholder="-- Pilih Kode PO --" autocomplete="off" required>
                                    <option value=""></option>
                                    <?php
