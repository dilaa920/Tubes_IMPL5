...
<section class="content-header">
    <h1>
        ...
        <a class="btn btn-primary btn-social pull-right" href="?module=form_purchase&form" title="Tambah Data"
            data-toggle="tooltip">
...
<section class="content">
    ...
    ?>
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              <td width='100' class='center'>$data[penerima]</td>
              <td width='100' class='center'>$data[alamat]</td>
              <td width='150' align='left'>$data[nama_barang]</td>
              <td width='10' align='center'>$data[total_keluar]</td>
