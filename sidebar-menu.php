...
// -------------------------------------------------------------
  ...
  if ($_GET["module"]=="purchase") { ?>
    <li class="active treeview">
        <a href="javascript:void(0);">
            <i class="fa fa-file-text"></i> <span>Transaksi Barang Masuk</span> <i
  ...
  if ($_GET["module"]=="barang_keluar") { ?>
    <li class="active treeview">
        <a href="javascript:void(0);">
            <i class="fa fa-file-text"></i> <span>Transaksi Barang Keluar</span> <i
                class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
  ...
  elseif ($_GET["module"]=="lap_barang_keluar") { ?>
    <li class="active treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="?module=lap_stok"><i class="fa fa-circle-o"></i> Stok Barang </a></li>
            <li><a href="?module=lap_barang_masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
            <li class="active"><a href="?module=lap_barang_keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a>
            </li>
        </ul>
    </li>
    <?php
  ...
  elseif ($_GET["module"]=="lap_barang_keluar") { ?>
    <li class="active treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="?module=lap_barang_masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
            <li><a href="?module=lap_barang_keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
            <li class="active"><a href="?module=cetak_faktur_keluar"><i class="fa fa-circle-o"></i> Cetak Faktur Keluar
                </a></li>
        </ul>
    </li>
    <?php
